...
#ifndef _IMX8MP_SDMA_HW_H
#define _IMX8MP_SDMA_HW_H
...
//
// IMX8MP SDMA event definitions.
// These values match the datasheet.
//
typedef enum _IMX8MP_SDMA1_EVENT_ID {
    IMX8MP_SDMA1_EVENT_ECSPI1_RX     = 0,
    IMX8MP_SDMA1_EVENT_ECSPI1_TX     = 1,
    IMX8MP_SDMA1_EVENT_ECSPI2_RX     = 2,
    IMX8MP_SDMA1_EVENT_ECSPI2_TX     = 3,
    IMX8MP_SDMA1_EVENT_ECSPI3_RX     = 4,
    IMX8MP_SDMA1_EVENT_ECSPI3_TX     = 5,
    IMX8MP_SDMA1_EVENT_CAN_FD1       = 8,
    IMX8MP_SDMA1_EVENT_CAN_FD2       = 9,
    IMX8MP_SDMA1_EVENT_IOMUX_1       = 14,
    IMX8MP_SDMA1_EVENT_IOMUX_2       = 15,
    IMX8MP_SDMA1_EVENT_I2C5          = 16,
    IMX8MP_SDMA1_EVENT_I2C6          = 17,
    IMX8MP_SDMA1_EVENT_I2C1          = 18,
    IMX8MP_SDMA1_EVENT_I2C2          = 19,
    IMX8MP_SDMA1_EVENT_I2C3          = 20,
    IMX8MP_SDMA1_EVENT_I2C4          = 21,
    IMX8MP_SDMA1_EVENT_UART1_RX      = 22,
    IMX8MP_SDMA1_EVENT_UART1_TX      = 23,
    IMX8MP_SDMA1_EVENT_UART2_RX      = 24,
    IMX8MP_SDMA1_EVENT_UART2_TX      = 25,
    IMX8MP_SDMA1_EVENT_UART3_RX      = 26,
    IMX8MP_SDMA1_EVENT_UART3_TX      = 27,
    IMX8MP_SDMA1_EVENT_UART4_RX      = 28,
    IMX8MP_SDMA1_EVENT_UART4_TX      = 29,
    IMX8MP_SDMA1_EVENT_ENET_QOS_EV0  = 32,
    IMX8MP_SDMA1_EVENT_ENET_QOS_EV1  = 33,
    IMX8MP_SDMA1_EVENT_ENET_QOS_EV2  = 34,
    IMX8MP_SDMA1_EVENT_ENET_QOS_EV3  = 35,
    IMX8MP_SDMA1_EVENT_FLEXSPI_TX    = 36,
    IMX8MP_SDMA1_EVENT_FLEXSPI_RX    = 37,
    IMX8MP_SDMA1_EVENT_GPT1          = 38,
    IMX8MP_SDMA1_EVENT_GPT2          = 39,
    IMX8MP_SDMA1_EVENT_GPT3          = 40,
    IMX8MP_SDMA1_EVENT_ENET1_EV2     = 44,
    IMX8MP_SDMA1_EVENT_ENET1_EV0     = 45,
    IMX8MP_SDMA1_EVENT_ENET1_EV3     = 46,
    IMX8MP_SDMA1_EVENT_ENET1_EV1     = 47
} IMX8MP_SDMA1_EVENT_ID;

typedef enum _IMX8MP_SDMA2_EVENT_ID {
    IMX8MP_SDMA2_EVENT_SAI1_RX       = 0,
    IMX8MP_SDMA2_EVENT_SAI1_TX       = 1,
    IMX8MP_SDMA2_EVENT_SAI2_RX       = 2,
    IMX8MP_SDMA2_EVENT_SAI2_TX       = 3,
    IMX8MP_SDMA2_EVENT_SAI3_RX       = 4,
    IMX8MP_SDMA2_EVENT_SAI3_TX       = 5,
    IMX8MP_SDMA2_EVENT_SAI5_RX       = 8,
    IMX8MP_SDMA2_EVENT_SAI5_TX       = 9,
    IMX8MP_SDMA2_EVENT_SAI6_RX       = 10,
    IMX8MP_SDMA2_EVENT_SAI6_TX       = 11,
    IMX8MP_SDMA2_EVENT_SAI7_RX       = 12,
    IMX8MP_SDMA2_EVENT_SAI7_TX       = 13,
    IMX8MP_SDMA2_EVENT_IOMUX_1       = 14,
    IMX8MP_SDMA2_EVENT_IOMUX_2       = 15,
    IMX8MP_SDMA2_EVENT_ASRC_0_RX     = 16,
    IMX8MP_SDMA2_EVENT_ASRC_0_TX     = 17,
    IMX8MP_SDMA2_EVENT_ASRC_1_RX     = 18,
    IMX8MP_SDMA2_EVENT_ASRC_1_TX     = 19,
    IMX8MP_SDMA2_EVENT_ASRC_2_RX     = 20,
    IMX8MP_SDMA2_EVENT_ASRC_2_TX     = 21,
    IMX8MP_SDMA2_EVENT_ASRC_3_RX     = 22,
    IMX8MP_SDMA2_EVENT_ASRC_3_TX     = 23,
    IMX8MP_SDMA2_EVENT_MICFIL        = 24,
    IMX8MP_SDMA2_EVENT_AUD2HTX       = 26,
    IMX8MP_SDMA2_EVENT_AUDIO_XCVR_RX = 30,
    IMX8MP_SDMA2_EVENT_AUDIO_XCVR_TX = 31,
    IMX8MP_SDMA2_EVENT_GPT4          = 38,
    IMX8MP_SDMA2_EVENT_GPT5          = 39,
    IMX8MP_SDMA2_EVENT_GPT6          = 40,
} IMX8MP_SDMA2_EVENT_ID;          
...
SDMA_CHANNEL_CONFIG Imx8mpDmaReqToChannelConfig[] = {
    // (0) SDMA_REQ_VPU           
    {                             
    ...
    // (58) SDMA_REQ_EXT1 -> Map to IMX8MP_SDMA1_EVENT_IOMUX_1
    {
        SDMA_UNSUPPORTED_REQUEST_ID, // Not supported
        SDMA_REQ_EXT1
    },
    // (59) SDMA_REQ_EXT2 -> Map to IMX8MP_SDMA1_EVENT_IOMUX_2
    {
        SDMA_UNSUPPORTED_REQUEST_ID, // Not supported
        SDMA_REQ_EXT2
    },
    ...
    // (71) SDMA_REQ_QSPI1_RX -> Event 37 (IMX8MP_SDMA1_EVENT_FLEXSPI_RX)
    {
        imx7_app_2_mcu_ADDR,            // Script address
        ...
        {
            {
                IMX8MP_SDMA1_EVENT_FLEXSPI_RX,
                DMA_EVENT_EXCLUSIVE
            },
        },
    },
    // (72) SDMA_REQ_QSPI1_TX -> Event 36 (IMX8MP_SDMA1_EVENT_FLEXSPI_TX)
    {
        imx7_mcu_2_app_ADDR,            // Script address
    ...
    // (75) SDMA_REQ_SAI1_TX -> SDMA instance 2 Event 1
    {
        ...
        {
            {
                IMX8MP_SDMA2_EVENT_SAI1_TX,
                DMA_EVENT_EXCLUSIVE
            },
        },
        1,                              // SDMA instance 2
    },
    // (76) SDMA_REQ_SAI1_RX -> SDMA instance 2 Event 0
    {
        ...
        {
            {
                IMX8MP_SDMA2_EVENT_SAI1_RX,
                DMA_EVENT_EXCLUSIVE
            },
        },
        1,                              // SDMA instance 2
    },
    // (77) SDMA_REQ_SAI2_TX -> SDMA instance 2 Event 3
    {
        imx7_mcu_2_sai_ADDR,            // Script address
        ...
        {
            {
                IMX8MP_SDMA2_EVENT_SAI2_TX,
                DMA_EVENT_EXCLUSIVE
            },
        },
        1,                              // SDMA instance 2
    },
    // (78) SDMA_REQ_SAI2_RX -> SDMA instance 2 Event 2
    {
        imx7_sai_2_mcu_ADDR,            // Script address
        ...
        {
            {
                IMX8MP_SDMA2_EVENT_SAI2_RX,
                DMA_EVENT_EXCLUSIVE
            },
        },
        1,                              // SDMA instance 2
    },
    // (79) SDMA_REQ_SAI3_TX -> SDMA instance 2 Event 5
    {
        imx7_mcu_2_sai_ADDR,            // Script address
        ...
        {
            {
                IMX8MP_SDMA2_EVENT_SAI3_TX,
                DMA_EVENT_EXCLUSIVE
            },
        },
        1,                              // SDMA instance 2
    },
    // (80) SDMA_REQ_SAI3_RX -> SDMA instance 2 Event 4
    {
        imx7_sai_2_mcu_ADDR,            // Script address
    ...
    // (83) SDMA_REQ_SAI5_TX -> SDMA instance 2 Event 9
    {
        imx7_mcu_2_sai_ADDR,            // Script address
        ...
        {
            {
                IMX8MP_SDMA2_EVENT_SAI5_TX,
                DMA_EVENT_EXCLUSIVE
            },
        },
        1,                              // SDMA instance 2
    },
    // (84) SDMA_REQ_SAI5_RX -> SDMA instance 2 Event 8
    {
        imx7_sai_2_mcu_ADDR,            // Script address
        ...
        {
            {
                IMX8MP_SDMA2_EVENT_SAI5_RX,
                DMA_EVENT_EXCLUSIVE
            },
        },
        1,                              // SDMA instance 2
    },
    // (85) SDMA_REQ_SAI6_TX -> SDMA instance 2 Event 11
    {
        imx7_mcu_2_sai_ADDR,            // Script address
        ...
        {
            {
                IMX8MP_SDMA2_EVENT_SAI6_TX,
                DMA_EVENT_EXCLUSIVE
            },
        },
        1,                              // SDMA instance 2
    },
    // (86) SDMA_REQ_SAI6_RX -> SDMA instance 2 Event 10
    {
        imx7_sai_2_mcu_ADDR,            // Script address
    ...
    // (98) SDMA_REQ_EXT3 -> Map to IMX8MP_SDMA2_EVENT_IOMUX_1
    {
        SDMA_UNSUPPORTED_REQUEST_ID, // Not supported
        SDMA_REQ_EXT3
    },
    // (99) SDMA_REQ_EXT4 -> Map to IMX8MP_SDMA2_EVENT_IOMUX_2
    {
        SDMA_UNSUPPORTED_REQUEST_ID, // Not supported
        SDMA_REQ_EXT4
    },
...
ULONG Imx8mpDmaReqMax = ARRAYSIZE(Imx8mpDmaReqToChannelConfig) - 1;

#endif // !_IMX8MP_SDMA_HW_H
