...
class GcKmImx8qxpMipiDsiDisplay : public GcKmBaseDisplay
{
public:

    GcKmImx8qxpMipiDsiDisplay(struct DisplayInterface *di, struct Imx8qxpDisplayPDEVs *pdevs)
    {
        ...
        //For now just assign plane 0 to MIPI0 (dpu stream 0), plane 1 for MIPI1 (dpi stream 1)
...
private:
    ...
    NwlDsiTransmitter m_DsiTransmitter;
