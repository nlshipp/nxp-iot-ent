...
// {16977919-9727-4e04-ABD6-7D04C3828977}
DEFINE_GUID(CLSID_MaloneMft,
            0x16977919, 0x9727, 0x4e04, 0xab, 0xd6, 0x7d, 0x4, 0xc3, 0x82, 0x89, 0x77);

#define MALONE_MFT_NAME     L"i.MX8QM/QXP Malone VPU MFT hardware accelerator"
...
public:
        ...
        ppv)
    {
        ...
        do {
            ...
            hr = CMaloneMft::CreateInstance(&pHWMFT);
            if (FAILED(hr)) {
                break;
            }
...
volatile ULONG  CMaloneMft::m_ulNumObjects          = 0;        // Number of active COM objects
...
HRESULT __stdcall DllCanUnloadNow(void)
{
    ...
    do {
        if ((ClassFactory::IsLocked() != FALSE) || (CMaloneMft::m_ulNumObjects != 0)) {
            break;
        }
...
HRESULT __stdcall DllRegisterServer(void)
{
    ...
    do {
        ...
        */
        ...
        hr = RegisterObject(CLSID_MaloneMft,
                            MALONE_MFT_NAME,
                            L"Both");
        if (FAILED(hr)) {
            break;
...
{
    UnregisterObject(CLSID_MaloneMft);
