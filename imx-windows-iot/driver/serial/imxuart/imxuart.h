...
enum IMX_UART_STATE : ULONG {
    ...
    PAUSED = (IMX_UART_STATE_ACTIVE | 0x06),
    PAUSING = (IMX_UART_STATE_ACTIVE | 0x08),
    RESUMING = (IMX_UART_STATE_ACTIVE | 0x09),
    COMPLETE = 0x06,
};
...
struct IMX_UART_INTERRUPT_CONTEXT {
    ...
    IMX_UART_STATE TxHoldState;
    IMX_UART_STATE RxHoldState;
