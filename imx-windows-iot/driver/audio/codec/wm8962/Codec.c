    ...
    )
{
    CODEC_COMMAND Commands[] =
    {
        ...
        { 0,    0x00, 0x26, 0x00, 0x1A },  // R38 - Right input PGA control - select IN1R/IN3R as the inputs to the input PGA.
        ...
        { 0,    0x00, 0x07, 0x00, 0x1e },  // R7 - Audio interface 0 - set word length to 32 bit, ADC L/R swapped. 
                                           // CAUTION: this gets reset by the 'DAC to Headphone Power Up' sequence.
