...
CMiniportTopologyIMXWAV::CMiniportTopologyIMXWAV
(
...
_Use_decl_annotations_
NTSTATUS
CMiniportTopologyIMXWAV::GetDescription
( 
...
--*/
{
    ...
    DPF_ENTER(("[CMiniportTopologyIMXWAV::Init]"));
...
_Use_decl_annotations_
NTSTATUS
CMiniportTopologyIMXWAV::PropertyHandlerGeneric
(
