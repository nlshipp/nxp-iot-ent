...
// Abstract:
//
//  This module contains the implementation of entry and exit point of IMU driver.
//
// Environment:
//
    ...
    )
{
    ...
    DriverConfig.DriverPoolTag = SENSORV2_POOL_TAG_IMU;
    ...
    {
        TraceError("IMU %!FUNC! WdfDriverCreate failed: %!STATUS!", Status);
        goto Exit;
    }
