...
class ImxPlatformBuilder(UpdateSettingsManager, SetupSettingsManager, BuildSettingsManager, UefiBuilder):
    ...
    def SetPlatformEnv(self):
        ...
        self.env.SetValue("ACTIVE_PLATFORM", "NXP/MX8M_NANO_EVK/MX8M_NANO_EVK.dsc", "Platform Hardcoded")
        self.env.SetValue("PRODUCT_NAME", "MX8M_NANO_EVK", "Platform Hardcoded")
    ...
    def SetPlatformEnvAfterTarget(self):
        ...
        self.env.SetValue("BUILD_OUTPUT_BASE", value, "Computed in MX8M_NANO_EVK Build")

        # Output FD file
        key = "OUTPUT_FD"
        value = os.path.join(self.env.GetValue("BUILD_OUTPUT_BASE"), "FV", "ClientBios.fd")
        self.env.SetValue(key, value, "Computed in MX8M_NANO_EVK Build")
