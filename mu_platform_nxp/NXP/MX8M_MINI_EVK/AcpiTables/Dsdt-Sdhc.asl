...
// Orders of the devices do not correspond with their names, this is due to change made to unify orders 
// of SDHC devices across all supported boards, so e.g. DISKPART will show eMMC as disk 0 and SD as 
// disk 1 no matter the board used.
