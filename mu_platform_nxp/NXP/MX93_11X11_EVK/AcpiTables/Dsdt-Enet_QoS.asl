...
Device (NET2) {
  ...
  Name (_CRS, ResourceTemplate () {
    MEMORY32FIXED (ReadWrite, 0x428A0000, 0x10000, )                    // ENET_QOS Base address
    Interrupt (ResourceConsumer, Level, ActiveHigh, Exclusive) { 216 }  // ENET_QOS IRQ
  })
  Name (MAC, Buffer (6) {})
  ...
  Name (_DSD, Package () {
    ...
    Package () { // RTL8211
      Package (2) {"CcmBase",                  0x44450000}, //Adress of the CCM module required for clock rate f due to link speed change
